...
public class Autor {
    ...
    @Column(unique = true) // Evita duplicar o mesmo autor
    private String nome;
    ...
    // "mappedBy" avisa que quem manda na relação é o atributo 'autor' na classe Livro
    @OneToMany(mappedBy = "autor", cascade = CascadeType.ALL, fetch = FetchType.EAGER)
    private List<Livro> livros = new ArrayList<>();

    public Autor() {} // Construtor padrão obrigatório para JPA
    ...
    public void setLivros(List<Livro> livros) {
        livros.forEach(l -> l.setAutor(this)); // Garante a vinculação bidirecional
        this.livros = livros;
    }
